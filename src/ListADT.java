...
public void removeAll(T elem); // Balio horretako elmentu guztiak ezabatuko ditu

public T first(); // listako lehen elementua ematen du

public T last(); // listako azken elementua ematen du

public ListADT<T> clone(); // Zerrendaren kopia bat bueltatuko du (adabegi guztiak kopiatuko dira)
